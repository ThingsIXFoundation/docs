...
problems. In case of problems try the dashboard in a new browser profile and only install
1 wallet plugin. Some browsers such as [Brave](https://brave.com/) come with
integrated wallet support that can also cause problems.
